...
protected:
     ...
     *********************************************************************/
public:
    enum SliderMode { Level, Adjust, Submaster, GrandMaster, Speed, FunctionSpeed, FunctionSize, FunctionRotation, FunctionMovement, FunctionXOffset, FunctionYOffset, FunctionFan, Strobe, FunctionShape };
    Q_ENUM(SliderMode)
