...
VCWidgetItem
{
    ...
    DropArea
    {
        ...
        onDropped:
        {
            ...
            {
                if (sliderObj.sliderMode === VCSlider.Speed || sliderObj.sliderMode === VCSlider.FunctionSpeed || sliderObj.sliderMode === VCSlider.FunctionSize || sliderObj.sliderMode === VCSlider.FunctionRotation || sliderObj.sliderMode === VCSlider.FunctionMovement || sliderObj.sliderMode === VCSlider.FunctionXOffset || sliderObj.sliderMode === VCSlider.FunctionYOffset || sliderObj.sliderMode === VCSlider.FunctionFan || sliderObj.sliderMode === VCSlider.FunctionShape)
                {
